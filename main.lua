...
if REPENTOGON and MinimapAPI then
    ...
    Resouled.AccurateStats = require("scripts.utility.accurate_stats")
    Resouled.Doors = require("scripts.utility.doors")
    Resouled.Iterators = require("scripts.utility.iterators")
    Resouled.Collectiblextension = require("scripts.utility.collectiblextension")
    Resouled.FamiliarTargeting = require("scripts.utility.familiar_targeting")
    Resouled.NpcHalo = require("scripts.utility.npc_halo")
    Resouled.Vector = require("scripts.utility.vector")
