...
local function onCacheEval(_, player, cacheFlag)
    player:CheckFamiliar(PROGLOTTID_VARIANT, player:GetCollectibleNum(RED_PROGLOTTID) + player:GetEffects():GetCollectibleEffectNum(RED_PROGLOTTID), player:GetCollectibleRNG(RED_PROGLOTTID), Isaac.GetItemConfig():GetCollectible(RED_PROGLOTTID), PROGLOTTID_SUBTYPE)
end
