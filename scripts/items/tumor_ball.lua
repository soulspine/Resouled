local TUMOR_BALL = Resouled.Enums.Items.TUMOR_BALL
...
local function onCacheEval(_, player)
    ...
    player:CheckFamiliar(FAMILIAR_VARIANT, tumorNum + player:GetEffects():GetCollectibleEffectNum(TUMOR_BALL), rng, Resouled.ItemConf:GetCollectible(TUMOR_BALL), FAMILIAR_SUBTYPE)
end
