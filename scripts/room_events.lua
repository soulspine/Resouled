...
include("scripts.room_events.haunted")
...
Resouled.RoomEventDescriptions = {
    ...
    [Resouled.RoomEvents.BLACK_CHAMPIONS] =
    "All enemies in the room become black explosive champions when entering the room",
    [Resouled.RoomEvents.BLESSING_OF_GLUTTONY] =
    "On room clear guarantees the room reward //endl// The room reward will be upgraded",
    ...
    [Resouled.RoomEvents.STATIC_SHOCK] =
    "Using an active item has a chance to deal damage to Isaac //endl// The higher charge, the higher chance of this occuring",
    [Resouled.RoomEvents.SPOILS_OF_WAR] =
    "Can only appear in Boss rooms //endl// Clearing that room grants an additional item as a reward",
    ...
    [Resouled.RoomEvents.EDENS_BLESSING] =
    "Appears only in rooms that contain items //endl// Spawns a one time use D6 for the room",
    [Resouled.RoomEvents.GREED_LOOMS] =
    "Appears only in shops //endl// If you exit the shop without buying anything the prices will be raised by 25%",
    [Resouled.RoomEvents.TAX_FOR_THE_MIGHTY] =
    "Appears only in shops //endl// Increased prices for each Q3+ item you own",
    [Resouled.RoomEvents.SHADOW_OF_FAMINE] =
    "Makes you unable to use your active item //endl// All spawned pickups are despawned",
    [Resouled.RoomEvents.BLESSING_OF_STEAM] =
    "Appears only in shops //endl// Everything in the shop becomes discounted by 25%",
    [Resouled.RoomEvents.BLESSING_OF_INNER_EYE] = "Reveals the nearest rooms in a 3x3 area",
    [Resouled.RoomEvents.CONJOINED_TWIN] =
    "After killing an enemy, you gain a small boost of velocity in a random direction",
    ...
    [Resouled.RoomEvents.ISAACS_BLESSING] =
    "Appears only in rooms that contain items //endl// Items in the room cycle between two random items from current item pool",
    [Resouled.RoomEvents.BUM_BO_IS_LOOSE] =
    "When entering a room, spawns an angry bumbo enemy that steals your money from the ground",
    [Resouled.RoomEvents.MIGHT_FOR_THE_MEEK] = "Grants a damage multiplier that's bigger when you have less souls",
    [Resouled.RoomEvents.PITY_FOR_THE_POOR] =
    "Discounts all items in the shop based on the amount of souls possessed when first entering it //endl// The less souls you have, the bigger the discount",
    [Resouled.RoomEvents.GUPPYS_PIECES] =
    "Replaces all items in the room with Guppy Pieces //endl// Only applicable to Treasure Rooms",
    [Resouled.RoomEvents.THE_ISAAC_OF_ISAAC_ISAAC] =
    "All enemies are replaced by Isaacs //endl// Isaacs behave like Isaac - shoots, dodges and moves around",
    [Resouled.RoomEvents.SPIDER_WEBS] =
    "Screen gets covered in a gigantic spider web //endl// Replaces free tiles with small spider webs that slow Isaac down",
    [Resouled.RoomEvents.HAUNTED] = "TODO"
}
