...
function Reid:AutoIcons(String)
    ...
    {[1] = "red", [2] = Reid:Chest(chests.Red)}, {[1] = "eternal", [2] = Reid:Chest(chests.Holy)}, {[1] = "spiked", [2] = Reid:Chest(chests.Spiked)},
    {[1] = "mimic ", [2] = Reid:Chest(chests.Trap)}, {[1] = "trapped", [2] = Reid:Chest(chests.Trap)}, {[1] = "mega", [2] = Reid:Chest(chests.Mega)},
    {[1] = "big", [2] = Reid:Chest(chests.Mega)}, {[1] = "bomb", [2] = Reid:Chest(chests.Stone)}, {[1] = "stone", [2] = Reid:Chest(chests.Stone)},
    {[1] = "wooden", [2] = Reid:Chest(chests.Wooden)}, {[1] = "haunted", [2] = Reid:Chest(chests.Haunted)}, {[1] = "old", [2] = Reid:Chest(chests.Dire)},
    ...
    String = repeatFindInsertUntilStringEnds(String, "grab bag", Reid:Sack(), nil, {[1] = "black", [2] = Reid:BlackSack()})
    ...
    String = repeatFindInsertUntilStringEnds(String, "speed", Reid:SpeedSmall(), nil, {[1] = "shot", [2] = Reid:ShotspeedSmall()})
    ...
    String = repeatFindInsertUntilStringEnds(String, "deal", Reid:DealChance(), nil, {[1] = "devil", [2] = ""}, {[1] = "angel", [2] = ""})
    ...
    String = repeatFindInsertUntilStringEnds(String, "marked", Reid:Marked(), nil, {[1] = "brimstone", [2] = Reid:Brimstone()})
    ...
    String = repeatFindInsertUntilStringEnds(String, "treasure", Reid:Treasure(), nil, {[1] = "greed", [2] = Reid:GreedTreasureRoom()})
    String = repeatFindInsertUntilStringEnds(String, "secret", Reid:Secret(), nil, {[1] = "super", [2] = Reid:SuperSecret()}, {[1] = "ultra", [2] = Reid:UltraSecret()})
    ...
    String = repeatFindInsertUntilStringEnds(String, "bedroom", Reid:Bedroom(), nil, {[1] = "dirty", [2] = Reid:DirtyBedroom()})
    String = repeatFindInsertUntilStringEnds(String, "mirror", Reid:Mirror())
    String = repeatFindInsertUntilStringEnds(String, "beggar", Reid:Beggar(), nil, {[1] = "demon", [2] = Reid:DemonBeggar()}, {[1] = "black", [2] = Reid:DemonBeggar()},
    {[1] = "key", [2] = Reid:KeyBeggar()}, {[1] = "bomb", [2] = Reid:BombBeggar()}, {[1] = "battery", [2] = Reid:BatteryBeggar()}, {[1] = "rotten", [2] = Reid:RottenBeggar()}
    )
    String = repeatFindInsertUntilStringEnds(String, "machine", "", nil, {[1] = "restock", [2] = Reid:RestockMachine()}, {[1] = "fortune", [2] = Reid:FortuneMachine()}, {[1] = "slot", [2] = Reid:SlotMachine()},
    ...
    String = repeatFindInsertUntilStringEnds(String, "mode", "", nil, {[1] = "hard", [2] = Reid:HardMode()}, {[1] = "greed", [2] = Reid:GreedMode()}, {[1] = "greedier", [2] = Reid:GreedierMode()})
    String = repeatFindInsertUntilStringEnds(String, "victory lap", Reid:VictoryLap())
    String = repeatFindInsertUntilStringEnds(String, "heart", Reid:Heart(), nil, {[1] = "half", [2] = Reid:Heart(hearts.Half)}, {[1] = "empty", [2] = Reid:Heart(hearts.Empty)},
    {[1] = "ethernal", [2] = Reid:Heart(hearts.Ethernal)}, {[1] = "eternal", [2] = Reid:Heart(hearts.Ethernal)}, {[1] = "soul", [2] = Reid:Heart(hearts.Soul)}, {[1] = "half soul", [2] = Reid:Heart(hearts.HalfSoul)},
    {[1] = "black", [2] = Reid:Heart(hearts.Black)}, {[1] = "half black", [2] = Reid:Heart(hearts.HalfBlack)}, {[1] = "demon", [2] = Reid:Heart(hearts.Black)}, {[1] = "bone", [2] = Reid:Heart(hearts.Bone)},
    {[1] = "half bone", [2] = Reid:Heart(hearts.Bone)}, {[1] = "empty bone", [2] = Reid:Heart(hearts.EmptyBone)}, {[1] = "full", [2] = Reid:Heart()}, {[1] = "rotten", [2] = Reid:Heart(hearts.Rotten)},
    {[1] = "rotten bone", [2] = Reid:Heart(hearts.RottenBone)}, {[1] = "blended", [2] = Reid:Heart(hearts.Blended)}, {[1] = "golden", [2] = Reid:Heart(hearts.Golden)}, {[1] = "coin", [2] = Reid:Heart(hearts.Coin)},
    {[1] = "half coin", [2] = Reid:Heart(hearts.HalfCoin)}, {[1] = "empty coin", [2] = Reid:Heart(hearts.EmptyCoin)}, {[1] = "broken", [2] = Reid:Heart(hearts.Broken)}, {[1] = "unknown", [2] = Reid:Heart(hearts.Unknown)}
    )
